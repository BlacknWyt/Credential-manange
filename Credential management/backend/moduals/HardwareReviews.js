...
exports.getUsersDiv1HR = () => {
  ...
  for (let i = 0; i < cred.fetchedCred.length; i++) {
    if (
      ...
      cred.fetchedCred[i].Ou.includes("Hardware Reviews")
    ) {
