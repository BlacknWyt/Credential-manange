...
router.get('/div1', (req, res) => {
    ...
    for(let i = 0; i < cred.fetchedCred.length; i++){
        if(cred.fetchedCred[i].Division.includes('div1') && cred.fetchedCred[i].Ou.includes('Opinion Publishing')){
...
router.get('/div2', (req, res) => {
    ...
    let arr = []
    for(let i = 0; i < cred.fetchedCred.length; i++){
        if(cred.fetchedCred[i].Division.includes('div2') && cred.fetchedCred[i].Ou.includes('Opinion Publishing')){
            arr.push(cred.fetchedCred[i])
        }
    }
    res.send(arr);
...
router.get('/div3', (req, res) => {
    ...
    let arr = []
    for(let i = 0; i < cred.fetchedCred.length; i++){
        if(cred.fetchedCred[i].Division.includes('div3') && cred.fetchedCred[i].Ou.includes('Opinion Publishing')){
            arr.push(cred.fetchedCred[i])
        }
    }
    res.send(arr);
...
router.get('/div4', (req, res) => {
    ...
    let arr = []
    for(let i = 0; i < cred.fetchedCred.length; i++){
        if(cred.fetchedCred[i].Division.includes('div4') && cred.fetchedCred[i].Ou.includes('Opinion Publishing')){
            arr.push(cred.fetchedCred[i])
        }
    }
    res.send(arr);
...
router.get('/div5', (req, res) => {
    ...
    let arr = []
    for(let i = 0; i < cred.fetchedCred.length; i++){
        if(cred.fetchedCred[i].Division.includes('div5') && cred.fetchedCred[i].Ou.includes('Opinion Publishing')){
            arr.push(cred.fetchedCred[i])
        }
    }
    res.send(arr);
